...
type: epic
priority: high
created_at: 2026-06-30T06:53:19Z
updated_at: 2026-06-30T06:53:19Z
---
...
Hordr's ADR-0011 (domain behavior in persona text, engine domain-agnostic) is the design choice that makes the integration clean. Both projects share the same principle: *describe the org in markdown, keep the runtime generic.*
...
- [ ] (deferred) TEAM.md support - org subtrees & manager relationships
- [ ] (deferred) TASK.md scheduler - time-based task activation
